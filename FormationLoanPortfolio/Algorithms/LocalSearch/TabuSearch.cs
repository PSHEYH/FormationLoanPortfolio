    ...
    class TabuSearch
    {
            ...
            double[] P_j, double a1, double a2, double r, double F)
        {
            ...
            while (_countOfEra!=0)
            {
                ...
                if(Algorithm.F(_probableVariants[0],k_j, t_j, d_j, P_j, a1, a2, r, F) < Algorithm.F(solution, k_j, t_j, d_j, P_j, a1, a2, r, F))
                {
                    for (int i = 0; i < _lengthOfIndivid; i++)
                    {
            ...
            double[] P_j, double a1, double a2, double r, double F)
        {
            ...
            for (int i = 0; i < _probableVariants.Count - 1; i++)
            {
                ...
                {
                    if (Algorithm.F(_probableVariants[i], k_j, t_j, d_j, P_j, a1, a2, r, F) > Algorithm.F(_probableVariants[j], k_j, t_j, d_j, P_j, a1, a2, r, F))
                    {
